...
export function Icon({ name, className = "h-5 w-5" }: { name: IconName; className?: string }) {
  ...
  if (name === "bitcoin") {
    return (
      <svg {...common}>
        <path d="M11.767 19.089c4.924.86 9.306-2.438 10.166-7.361.86-4.923-2.438-9.306-7.361-10.166-4.924-.86-9.306 2.438-10.166 7.361-.86 4.924 2.438 9.306 7.361 10.166Zm2.01-2.846l-.504-2.88a.933.933 0 0 1 .753-1.077c1.07-.187 1.258-1.258.914-3.23-.344-1.97-.938-2.502-1.99-2.318a.933.933 0 0 1-1.077-.753l-.504-2.88-1.874.327.485 2.768a.933.933 0 0 1-.752 1.077c-1.01.176-1.57.275-2.09.366a.933.933 0 0 1-1.078-.753l-.485-2.768-1.874.327.504 2.88a.933.933 0 0 1-.753 1.077c-1.07.187-1.258 1.258-.914 3.23.344 1.97.938 2.502 1.99 2.318a.933.933 0 0 1 1.077.753l.504 2.88 1.874-.327-.485-2.768a.933.933 0 0 1 .752-1.077c1.01-.176 1.57-.275 2.09-.366a.933.933 0 0 1 1.078.753l.485 2.768 1.874-.327Z" fill="currentColor"/>
      </svg>
    );
  }
