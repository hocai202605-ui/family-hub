...
| `app/(dashboard)/calendar/` | Daily habits + weekly log; `yearly/` habit report + events year grid |
...
| Calendar (habits + daily log) | `/calendar` live API; `/calendar/yearly` habit KPIs + household events |
